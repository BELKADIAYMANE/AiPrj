...
def is_solvable(puzzle):
    ...
    flat_puzzle = [tile for row in puzzle.cells for tile in row]
    ...
    # Find the row position of the blank space (0) from the bottom
    blank_row_from_bottom = 4 - next(
        row for row, tiles in enumerate(puzzle.cells) if 0 in tiles
    )
